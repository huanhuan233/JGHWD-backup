def build_content_prompt(article_title: str, section_outline: str, kb_text: str = "", hw_text: str = "", min_words: str = "",prev_content: str="",custom_prompt: str="") -> str:
    """
    构造用于大模型生成结构化段落的提示词 prompt，强化 Markdown 格式严谨性。
    """
    return (
        f"你是一个文章撰写专家，你在为一个名字叫《{article_title}》的大纲内容进行扩写，此处尽量使用表格表示"
